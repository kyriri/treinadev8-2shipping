...
describe 'User visits page for their own outposts' do
  it 'succesfully' do 
    ...
    Outpost.create!(shipping_company: sc1, name: 'Aeroporto', city_state: 'São Paulo, SP', category: 'centro de envios aéreos')
    ...
    expect(current_path).to eq outposts_path
